...
/* package validation-book-0.1.0.0 */
#ifndef VERSION_validation_book
#define VERSION_validation_book "0.1.0.0"
#endif /* VERSION_validation_book */
#ifndef MIN_VERSION_validation_book
#define MIN_VERSION_validation_book(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_validation_book */
...
#define CURRENT_COMPONENT_ID "validation-book-0.1.0.0-3Kz75VpXPuV4PufdFRCjYl-validation-book"

...
/* package hello-w-0.1.0.0 */
#define VERSION_hello_w "0.1.0.0"
#define MIN_VERSION_hello_w(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hello-w-0.1.0.0"

#define CURRENT_PACKAGE_KEY "hello-w-0.1.0.0"
